...
if __name__ == '__main__':
    ...
    parser.add_argument('-s', '--strategy', type=str, help='strategy type -"rsi" and "rsi_2" are supported',
                        default='rsi_2')
    parser.add_argument('-v', '--volume', type=int, help='basic trading volume', default=100)
